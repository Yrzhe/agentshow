/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b3065417539bd2bb6174f18e544c2cce)
// Runtime types generated with workerd@1.20260815.1 2026-08-04 nodejs_compat
interface __BaseEnv_Env {
	IDP_ISSUER: "http://localhost:8788";
	IDP_BRAND: "Cloudflare OS";
	IDP_CLIENT_ID: "local-development";
	IDP_REDIRECT_URI: "http://localhost:8788/callback";
	IDP_ALLOWED_EMAILS: "@example.com";
	IDP_MAIL_FROM: "Cloudflare OS <login@example.com>";
	IDP_CODE_TTL_SECONDS: "600";
	IDP_MAX_ATTEMPTS: "5";
	IDP_MAX_SENDS_PER_SESSION: "3";
	IDP_MAX_SENDS_PER_EMAIL: "5";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IDP_ISSUER" | "IDP_BRAND" | "IDP_CLIENT_ID" | "IDP_REDIRECT_URI" | "IDP_ALLOWED_EMAILS" | "IDP_MAIL_FROM" | "IDP_CODE_TTL_SECONDS" | "IDP_MAX_ATTEMPTS" | "IDP_MAX_SENDS_PER_SESSION" | "IDP_MAX_SENDS_PER_EMAIL" | "IDP_SEND_WINDOW_SECONDS">> {}
}
